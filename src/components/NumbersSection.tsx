        ...
        <div className="row">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-[#d7e9ff] flex flex-col items-center text-center p-6 pb-10 rounded-xl">
              ...
              <div className="text-[32px] md:text-[40px] text-[#032b41] font-semibold mb-4">3 Million</div>
              <div className="text-[#394547] text-sm md:text-[16px] font-light">Downloads on all platforms</div>
            </div>
            <div className="bg-[#d7e9ff] flex flex-col items-center text-center p-6 pb-10 rounded-xl">
              ...
              <div className="text-[32px] md:text-[40px] text-[#032b41] font-semibold mb-4">4.5 Stars</div>
              <div className="text-[#394547] text-sm md:text-[16px] font-light">
            ...
            <div className="bg-[#d7e9ff] flex flex-col items-center text-center p-6 pb-10 rounded-xl">
              ...
              <div className="text-[32px] md:text-[40px] text-[#032b41] font-semibold mb-4">97%</div>
              <div className="text-[#394547] text-sm md:text-[16px] font-light">
