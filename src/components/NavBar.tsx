      ...
      <nav className="h-[80px]">
        <div className="flex justify-between items-center max-w-[1070px] w-full h-full mx-auto px-6">
          <div className="flex justify-center items-center flex-grow">
            <Image src={logo} width={200} height={80} className="max-w-[400px] h-auto object-contain" alt="Logo" />
          </div>
          <ul className="flex gap-6">
            <li className="cursor-pointer text-[#032b41] hover:text-[#2bd97c] ">Login</li>
