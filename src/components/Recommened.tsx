...
const Recommended = () => {    
  ...
  return (      
    <div>        
      ...
      <h4 className="font-light text-[#394547] mb-4">We Think you&apos;ll like this</h4>        
      <div className="flex">          
        {books.map(book => (         
          <div key={book.id} className="w-1/5 p-1">              
            <Image src={book.imageLink} width={170} height={100} alt={book.title} />              
            <h2 className="font-bold text-[#032b41] mb-2 line-clamp-2 w-[150px]">{book.title}</h2>              
            ...
            <div className="flex">                
              ...
              <div className="flex ml-2">                  
                ...
                <h4 className="text-sm ml-1 font-light text-[#6b757b]">{book.averageRating}</h4>                
              </div>              
            </div>            
          </div>         
        ))}        
